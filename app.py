...
_LOGO_ESCURO = _logo_b64("logo_escuro.svg")
...
<style>
    ...
    .cabecalho {
        background: linear-gradient(135deg, #033843 0%, #036578 100%);
        border-radius: 12px;
        padding: 1.3rem 2rem;
        color: #fff;
    ...
    .card-link     {border-left: 5px solid #036578; background: #f0fafa;}
    ...
    .badge-link      {background: #036578; color: #fff;}
    ...
    if pdfs_disponiveis:
        ...
        with col_print:
            st.markdown(
                ...
                "background:#036578;color:#fff;border:none;border-radius:6px;"
